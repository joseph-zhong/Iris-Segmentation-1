...
void MedianFilter(Image* inputImage, Image* outputImage, int blurRadius)
{
	ctmf(*inputImage->getData(), 
		*outputImage->getData(),
		inputImage->getNumColumns(), 
		inputImage->getNumRows(),
		inputImage->getNumColumns(), 
		outputImage->getNumColumns(), 
		blurRadius, 
		1, 
		1024*1024);
}
